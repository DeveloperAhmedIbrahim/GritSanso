                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           ...
                                           <a href="<?php echo e(url('/service_category/create')); ?>" class="btn backgroundbuttoncolor">Add Service Category</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="<?php echo e(url('/service_category/'.$value->id.'/delete')); ?>" class="btn backgroundbuttoncolor">Delete</a>
        </div>
      </div>
...
<?php echo $__env->make('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('service_categories'),'sub_category_name' => __(''),  'page_name' => __('manage_service_categories')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gritsansoh/public_html/resources/views/admin/service_category/index.blade.php ENDPATH**/ ?>