@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('payment gateway'),'sub_category_name' => __(''),  'page_name' => __('manage_paymentgateway')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                  <div class="table-responsive">
                    <table id="alter_pagination" class="table table-hover non-hover paymentgateway" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>id</th>
                                        <th>Gateway</th>
