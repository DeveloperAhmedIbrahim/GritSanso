...
<div class="container">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           ...
                                           <a href="{{ url('/service_category') }}" class="btn backgroundbuttoncolor">Manage Service Category</a>
                                        </div>
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/service_category/store') }}" method="POST" id="formfordoctor">
                        @csrf
                    <div class="row">
                    <div class="col-md-6">
                    <div class="form-group">
                    <label>Service<span class="text-danger">*</span></label>
                    <input type="text" name="service" class="form-control @error('service') is-invalid @enderror" placeholder="Enter Name"value="{{ old('service') }}">
                    @error('service')
