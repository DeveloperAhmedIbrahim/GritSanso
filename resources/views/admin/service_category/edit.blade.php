@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('service_categories'),'page_name' => __('add_service_categories')])
...
<div class="container">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-8 col-md-8 col-sm-3 col-3" style="text-align:right;">

                                           <a href="" class="btn backgroundbuttoncolor">Manage Service Category</a>
                                        </div>
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/service_category/'.$service_category->id.'/update') }}" method="POST" id="formfordoctor">
                        @csrf
                        @method('PUT')
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="text" name="service" class="form-control @error('service') is-invalid @enderror" placeholder="Enter Name"value="{{ $service_category->service }}">
                    @error('service')
                    ...
                    <textarea name="service_descriptin" class="form-control" id="ck_editor"> {{ $service_category->service_descriptin }} </textarea>
                     @error('service_descriptin')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                    @enderror
