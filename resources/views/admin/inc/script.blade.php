...
<script type="text/javascript">
  ...
  <script type="text/javascript">
      ...
      $.ajax({
              url: '{{ url('/showpublishdraftblog') }}/'+id,
              type: 'POST',
...
<script>
    ...
    @case('manage_service_categories')
  ...
  $(document).on('change' , '#inputt' , function(){
    ...
    var id=$(this).attr("data-id");
     ...
     $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: { _token:'{{ csrf_token() }}' , id: id , clearance :clearance},
