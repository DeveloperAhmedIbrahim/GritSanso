    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{ url('dashboard') }}" class="nav-link ml-2">@if(!empty($websetting->dashboard_icon)) <img src="{{ asset('WebSetting/'.$websetting->dashboard_icon) }}" width="60" height="60" style="border-radius: 5%;"> @else {{ $websetting->name }} @endif</a>
            </li>
