@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('dashboard'),'page_name' => __('manage_profile')])
{{-- @section('page_title' ,$page_title) --}}
@section('content')

@php $websetting=\App\Models\WebSetting::first();
@endphp
<div class="container-fluid mt-3">
<div class="col-lg-12 text-right" style="margin-top: 100px">
<a href="{{ url('/edit/profile') }}" class="btn" style="box-shadow: 20px; background-color: #009688!important;"><i class="fa fa-pencil text-white" style="font-size: 30px;" aria-hidden="true"></i></a>
</div>
<div class="wrapper" style="margin-left: 130px;">
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="@if(empty(auth()->guard('admin')->user()->profile_picture)) {{ asset('assets/img/dumy.jpg') }} @else {{ asset('admin_profile/'.auth()->guard('admin')->user()->profile_picture) }} @endif" alt="profile card">
    </div>
    
    <div class="profile-card__cnt js-profile-cnt">

      <div class="profile-card__name"> {{ auth()->guard('admin')->user()->name }}</div>
      <div class="profile-card__txt">Admin Of<strong class="ml-2"> @if(!empty($websetting->name)) {{ $websetting->name }}   @else Admin name @endif</div>
