@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('blog'),'sub_category_name' => __(''),  'page_name' => __('manage_category')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-12 col-12">
                                           <a href="{{ url('/category/create') }}" class="btn backgroundbuttoncolor">Add Category</a>
                                        </div>
                                        </div>                                                        
                                </div>
                                {{-- <div class="jumbotron">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/category/'.$value->id.'/delete') }}" class="btn backgroundbuttoncolor">Delete</a>
        </div>
      </div>
