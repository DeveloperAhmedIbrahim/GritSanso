@extends('admin.layouts.master' , ['category_name' => 'dashboard' , 'page_name' => 'admin_dashboard'])
@section('content')
        <!--  BEGIN CONTENT AREA  -->
                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget">
                            ...
                            <h2 class="font-weight-italic" style="font-size: 40px;">{{ $all_coach }}</h2>
                            <h5 class="font-weight-italic">Total Coach</h5>
                            <a href="{{ url('/coach') }}" class="btn mt-3" style="background: #009688; color: white;">View All</a>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget">
                             <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <h2 class="font-weight-italic" style="font-size: 40px;">{{ $blog }}</h2>
                            <h5 class="font-weight-italic">Total Blogs</h5>
                            <a href="{{ url('/blog') }}" class="btn mt-3" style="background: #009688; color: white;">View All</a>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <div class="widget">
                            ...
                            <h2 class="font-weight-italic" style="font-size: 40px;">{{ $author }}</h2>
                            <h5 class="font-weight-italic">Total Authors</h5>
                            <a href="{{ url('/author') }}" class="btn mt-3" style="background: #009688; color: white;">View All</a>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <div class="widget">
                             <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <h2 class="font-weight-italic" style="font-size: 40px;">{{ $service }}</h2>
                            <h5 class="font-weight-italic">Categories</h5>
                            <a href="{{ url('/service_category') }}" class="btn mt-3" style="background: #009688; color: white;">View All</a>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
