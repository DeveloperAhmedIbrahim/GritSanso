@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('booking'),'sub_category_name' => __(''),  'page_name' => __('manage_booking')])
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/booking/'.$value->id.'/delete') }}" class="btn backgroundbuttoncolor">Delete</a>
        </div>
      </div>
