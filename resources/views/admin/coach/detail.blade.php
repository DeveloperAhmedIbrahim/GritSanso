                                    ...
                                    <div class="table-responsive">
                                       ...
                                       $i=1;
                                              ...
                                              <tr>
                                                            <td>{{ $i++  }}</td>
                                                                <td>
                                                                  <iframe type="{{ $value->attachment_type }}" src="{{ !empty($value->attachment) ? asset($value->attachment) : asset('assets/img/Introvideo.mp4') }}" width="300" height="200"></iframe>
