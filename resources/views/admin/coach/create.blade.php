@extends('admin.layouts.master' , ['class' => 'off-canvas-sidebar', 'category_name' => __('coach'),'page_name' => __('add_coach')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/coach/store') }}" method="POST" id="formfordoctor">
                        @csrf
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control  @error('email') is-invalid @enderror" placeholder="e.g xyz@gmail.com"  value="{{ old('email') }}">
                     @error('email')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
