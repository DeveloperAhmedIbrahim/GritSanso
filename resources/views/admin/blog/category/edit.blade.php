...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/category/'.$category->id.'/update') }}" method="POST" id="formfordoctor">
                        @csrf
                        @method('PUT')
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="text" name="subtitle" class="form-control" placeholder="Enter Subtitle"  value="{{ $category->subtitle }}">
                    </div>
                    @error('subtitle')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    ...
                    <textarea name="description" class="form-control" id="ck_editor">{{ $category->description  }}</textarea>
                    </div>
                    @error('description')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
